...
class VersionsRelationManager extends RelationManager
{
    ...
    public function form(Schema $schema): Schema
    {
        return $schema->schema([
            ...
            FormComponents\FileUpload::make('zip_file')
                ...
                ->disk('local')
                ->directory('themes/uploads/temp')
                ->visibility('private')
                ->preserveFilenames()
                ->columnSpanFull()
                ->helperText('Upload the theme .zip file. Leave empty to keep existing file.'),
     ...
     */
    protected function processZipFile(ThemeVersion $version, ?string $tempPath): void
    {
        if (empty($tempPath)) {
            return;
        }
        ...
        $fileName = $theme->slug . '-' . $version->version . '.zip';
        $directory = 'themes/' . $theme->slug;
        ...
        return $table
            ...
            ->headerActions([
                Actions\CreateAction::make()
                    ->after(function (ThemeVersion $record, array $data) {
            ...
            ->actions([
                ...
                Actions\DeleteAction::make()
                    ->before(function (ThemeVersion $record) {
